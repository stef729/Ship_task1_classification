...
sys.path.insert(1, os.path.join(os.path.abspath('..'), 'utils'))
sys.path.append('..')
import numpy as np
import argparse
import h5py
...
def train(model_list_one):
    ...
    for batch_data_dict in data_generator.generate_train():
        ...
        # Evaluate
        #1800
        if iteration % 500 == 0 and iteration > ite_eva:
            logging.info('------------------------------------')
        ...
        # Save model
        if iteration % 500 == 0 and iteration > ite_store:
            checkpoint = {
                'iteration': iteration, 
...
if __name__ == '__main__':
    ...
    # model_list = ['Ensemble_CNN','Logmel_Res38','Logmel_Wavegram_Logmel_Cnn14','Logmel_Cnn14','Logmel_Cnn10','Logmel_MobileNetV2','Logmel_MobileNetV1','Logmel_Wavegram_Cnn14','Ensemble_CNN2','Logmel_MultiFrebands_CNN','Logmel_SubFrebands_CNN','Cqt_SubFrebands_CNN','Gamm_SubFrebands_CNN','Mfcc_SubFrebands_CNN','Logmel_MultiFrames_CNN','Cqt_MultiFrames_CNN','Gamm_MultiFrames_CNN','Mfcc_MultiFrames_CNN','Ensemble_CNN3','Ensemble_CNN5','Ensemble_CNN6','Ensemble_CNN4','Ensemble_Models']
    
    
    # model_list = ['Ensemble_CNN3','Ensemble_CNN5','Ensemble_CNN6','Ensemble_CNN4','Ensemble_Models']
    # for i in model_list:
    #     print("Current model is: {}.".format(i))
    #     train(i)
    #     print("{} model is done!".format(i))
