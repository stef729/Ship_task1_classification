...
def plot_results(args):
    ...
    workspace = 'D:/Project/DCASE/2020-Task1A-PKU'
    subtask = 'a'
    ...
    def _load_stat(model_type, subtask, source):
        ...
        validate_statistics_path = os.path.join(workspace, 'statistics', filename, 
            '{}_logmel_{}frames_{}melbins'.format(prefix, frames_per_second, mel_bins), 
    ...
    if subtask == 'a':
        ...
        results = _load_stat('Logmel_Cnn', subtask, source=source)
